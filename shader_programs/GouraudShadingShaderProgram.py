...
class GouraudShadingShaderProgram():
    ...
    def __init__(self):
        ...
        light_model = GouraudShadingShaderProgram.POINT_LIGHT;
        specular_mode = GouraudShadingShaderProgram.PHONG_SPECULAR;
        has_attenuation = 0;
    ...
    def setUniformLightMode(self, light_mode):
        ...
        if(light_mode >= 3 and light_mode <= 5):
            ...
            gl.glUniform1i(self.__lightModelLoc, GouraudShadingShaderProgram.POINT_LIGHT)
    ...
    def setUniformSpecularMode(self, specular_mode):
        ...
        if(specular_mode == 6 or specular_mode == 7):
            ...
            gl.glUniform1i(self.__specularModelLoc, GouraudShadingShaderProgram.PHONG_SPECULAR)
