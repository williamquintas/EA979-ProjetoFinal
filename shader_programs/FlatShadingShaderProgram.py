...
class FlatShadingShaderProgram():
    ...
    def setUniformLightMode(self, light_mode):
        ...
        if(light_mode >= 3 and light_mode <= 5):
            ...
            print("FlatShadingShaderProgram::setUniformLightMode --> modo inválida. Mudando para modo Point light!")
            gl.glUniform1i(self.__lightModelLoc, FlatShadingShaderProgram.POINT_LIGHT)
    ...
    def setUniformSpecularMode(self, specular_mode):
        ...
        if(specular_mode == 6 or specular_mode == 7):
            ...
            print("FlatShadingShaderProgram::setUniformSpecularMode --> modo inválida. Mudando para modo Phong specular!")
            gl.glUniform1i(self.__specularModelLoc, FlatShadingShaderProgram.PHONG_SPECULAR)
